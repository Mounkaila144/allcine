 ...
 */
final class Version20220404184023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pub (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) DEFAULT NULL, nom VARCHAR(50) NOT NULL, video_name VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
